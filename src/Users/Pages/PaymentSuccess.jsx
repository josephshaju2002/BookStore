      ...
      <Header/>
        <div className="grid grid-cols-2 py-20 px-40 justify-center items-center">
            <div>
                ...
                <p className='mt-5 mb-10'>ThankYou for shopping with Bookstore. Hope you have a good time ahead</p>
            ...
            <div>
                <img className='w-3/4 ms-30' src="https://funtura.in/wp-content/themes/funtura/assets/images/success.svg" alt="" />
            </div>
        </div>
      <Footer/>
    </>
