...
function EditProfile() {
  ...
  const submitUpdatedProfile = async () => {
    const { username, password, confirmPassword, bio, role, profile } =
      userDetails;
        ...
        <div>
          ...
          <div className="bg-white h-full w-90 z-50 fixed top-0 left-0">
            ...
            <div className="flex justify-end w-full px-5">
              <button
                onClick={reset}
                className="bg-amber-600 text-white rounded border py-3 px-4 hover:text-amber-600 hover:border-amber-600 hover:bg-white"
              >
                Reset
              </button>
              <button
                onClick={submitUpdatedProfile}
                className="bg-green-600 text-white rounded border py-3 px-4 hover:text-green-600 hover:border-green-600 hover:bg-white ms-3"
              >
                Update
              </button>
            </div>
